...
#   }
#   
#   #apagar a ?ltima linha do arquivo
...
# 
#     # Coluna name_muni
#     setnames(dado2, "MUNIC?PIO", "name_muni")
#     dado2$name_muni = NULL
# 
#   }
# 
...
#   if(year_RM==2001){ setDT(dado2)[ !(name_metro %like% 'Distrito Federal|Aglomera??o Urbana|RIDE|Colar Metropolitano|?rea de Expans?o|N?cleo Metropolitano'), name_metro := paste0('RM ', name_metro)] }
# 
# 
# 
# # read muni shapes
...
#   }
#   
#   #apagar as 2 ?ltimas linhas do arquivo
...
#     dado2 <- dplyr::rename(dado1, code_muni = `C?digo Munic?pio`)
#   } else {
...
#                             name_metro = `regi?o metropolitana, ride ou aglomera??o urbana`,
#                             subdivision = `subdivis?es`,
#                             legislation = `legisla??o`,
...
#                             subdivision = `subdivis?es`,
#                             legislation = `legisla??o`,
#                             legislation_date = `data de publica??o da lei`,
